...
#     I do not own the file. All rights reserved to the original author                   
...
class Obstacle:
    def __init__(self, cx, cy, radius):
        '''
        place a circular obstacle on the map using its specified center coordinates and radius
        '''
        self.cx = cx
        self.cy = cy
        self.radius = radius
    ...
    def show(self):
        '''
        function to show the obstacle using matplotlib's built-in function
        '''
